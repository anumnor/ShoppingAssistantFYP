    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.contentSection}>
        ...
        <View style={styles.gridContainer}>
          {/* Create List Button - Link to CreateListScreen */}
          <TouchableOpacity 
            style={styles.actionCard} 
            onPress={() => navigation.navigate('CreateListScreen')}
          >
            <View style={[styles.iconCircle, { backgroundColor: '#EEF2FF' }]}>
               <Text style={{fontSize: 24, color: '#4F46E5'}}>â‰¡+</Text>
            </View>
          ...
          <TouchableOpacity style={styles.actionCard}>
            <View style={[styles.iconCircle, { backgroundColor: '#FFF7ED' }]}>
               <Text style={{fontSize: 24, color: '#EA580C'}}>ðŸ•’</Text>
            </View>
          ...
          <TouchableOpacity 
  style={styles.actionCard} 
  onPress={() => navigation.navigate('CashierDashboardScreen')} // Ye line add karni hai
>
  <View style={[styles.iconCircle, { backgroundColor: '#FDF2F8' }]}>
      <Text style={{fontSize: 24, color: '#DB2777'}}>ðŸ‘¤</Text>
  </View>
